...
class AdminController extends Controller
{
    ...
    {
        $students = [
            ['id' => 'STU001', 'name' => 'Md. Rafiul Islam', 'email' => 'rafiul.islam@student.com', 'class' => 'Class 6A', 'gender' => 'Male', 'date_of_birth' => '2010-05-15', 'status' => 'Active'],
            ['id' => 'STU002', 'name' => 'Fatema Akter', 'email' => 'fatema.akter@student.com', 'class' => 'Class 6A', 'gender' => 'Female', 'date_of_birth' => '2010-07-22', 'status' => 'Active'],
            ['id' => 'STU003', 'name' => 'Md. Sakib Rahman', 'email' => 'sakib.rahman@student.com', 'class' => 'Class 6B', 'gender' => 'Male', 'date_of_birth' => '2010-03-10', 'status' => 'Active'],
            ['id' => 'STU004', 'name' => 'Tasnia Haque', 'email' => 'tasnia.haque@student.com', 'class' => 'Class 6B', 'gender' => 'Female', 'date_of_birth' => '2010-09-18', 'status' => 'Active'],
            ['id' => 'STU005', 'name' => 'Md. Tanvir Hossain', 'email' => 'tanvir.hossain@student.com', 'class' => 'Class 7A', 'gender' => 'Male', 'date_of_birth' => '2009-06-25', 'status' => 'Active'],
            ['id' => 'STU006', 'name' => 'Nusrat Jahan', 'email' => 'nusrat.jahan@student.com', 'class' => 'Class 7A', 'gender' => 'Female', 'date_of_birth' => '2009-11-30', 'status' => 'Active'],
            ['id' => 'STU007', 'name' => 'Md. Ashraful Alam', 'email' => 'ashraful.alam@student.com', 'class' => 'Class 7B', 'gender' => 'Male', 'date_of_birth' => '2009-02-14', 'status' => 'Active'],
            ['id' => 'STU008', 'name' => 'Farjana Sultana', 'email' => 'farjana.sultana@student.com', 'class' => 'Class 7B', 'gender' => 'Female', 'date_of_birth' => '2009-08-05', 'status' => 'Active'],
            ['id' => 'STU009', 'name' => 'Md. Kamal Uddin', 'email' => 'kamal.uddin@student.com', 'class' => 'Class 8A', 'gender' => 'Male', 'date_of_birth' => '2008-04-20', 'status' => 'Active'],
            ['id' => 'STU010', 'name' => 'Sabrina Yasmin', 'email' => 'sabrina.yasmin@student.com', 'class' => 'Class 8A', 'gender' => 'Female', 'date_of_birth' => '2008-12-08', 'status' => 'Active'],
            ['id' => 'STU011', 'name' => 'Md. Rashed Khan', 'email' => 'rashed.khan@student.com', 'class' => 'Class 8B', 'gender' => 'Male', 'date_of_birth' => '2008-01-17', 'status' => 'Active'],
            ['id' => 'STU012', 'name' => 'Lamia Ahmed', 'email' => 'lamia.ahmed@student.com', 'class' => 'Class 8B', 'gender' => 'Female', 'date_of_birth' => '2008-10-03', 'status' => 'Active'],
        ];
